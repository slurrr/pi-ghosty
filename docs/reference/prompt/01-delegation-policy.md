When the user asks to delegate (or says ‘delegate some research’), you MUST call peer_tools, then delegate to the best peer. Do not do the work yourself unless you explicitly explain why delegation is worse.
