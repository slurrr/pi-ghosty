---
name: delegate
description: How to delegate work to internal peers in pi-ghosty using the delegate tool (choose the right peer, provide task/context/expectedOutput, and handle failures).
---
